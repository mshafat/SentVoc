// ভার্সন কোড নেম: SentVoc v4.6 - Final UI Sync & Sentence Translation Fix
...
// --- ডিকশনারি ও সেন্টেন্স ট্রান্সলেশন ফিক্স ---
async function lookup(word) {
    ...
    const tl = document.getElementById('target-lang').value; // টার্গেট ল্যাংগুয়েজ সিঙ্ক
    const card = currentSessionCards[currentIndex];
    ...
    try {
        ...
        // পুরো বাক্যের অনুবাদ (টার্গেট ল্যাংগুয়েজে)[cite: 1]
...
// --- কার্ড ডিসপ্লে (v4.4 নীল টেক্সট ডিজাইন) ---
function showCard() {
    const card = currentSessionCards[currentIndex];
    ...
    if (isFlipped) {
        // v4.4 এর সেই নীল টেক্সট ডিজাইন ফিরিয়ে আনা হয়েছে
...
// --- মাস্টারড লিস্ট ও ডাটা হ্যান্ডলিং ---
